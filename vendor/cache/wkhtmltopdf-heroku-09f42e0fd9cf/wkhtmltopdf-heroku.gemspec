...
Gem::Specification.new do |s|
  ...
  s.files = [".document", "Gemfile", "Gemfile.lock", "LICENSE.txt", "README.mdown", "Rakefile", "VERSION", "bin/wkhtmltopdf-linux-amd64", "lib/wkhtmltopdf-heroku.rb", "test/helper.rb", "test/test_wkhtmltopdf_heroku_and_osx_binaries.rb", "wkhtmltopdf-heroku.gemspec"]
